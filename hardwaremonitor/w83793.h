...
//#define V33_I0C_QUERY _IOWR(HWM_IOC_MAGIC,1,int)
//#define V5_I0C_QUERY _IOWR(HWM_IOC_MAGIC,2,int)
//#define VCPU_I0C_QUERY _IOWR(HWM_IOC_MAGIC,3,int)
//#define V12_I0C_QUERY _IOWR(HWM_IOC_MAGIC,4,int)

//#define HWM_I0C_QUERY _IOWR(HWM_IOC_MAGIC,5,int)
